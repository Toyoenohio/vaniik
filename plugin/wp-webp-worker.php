 ...
 * Description:       Convierte imágenes a WebP mediante un Worker de Cloudflare (al subir y en lote) y las sirve por .htaccess. Herramienta para operar librerías grandes de clientes.
 * Version:           1.0.0
